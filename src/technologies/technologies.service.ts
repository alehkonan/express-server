...
export class TechnologiesService {
  ...
  async create(technology: CreateTechnologyDto): Promise<Technology | undefined> {
    const queryRunner = this.connection.createQueryRunner()
  ...
  async update(id: string, technology: UpdateTechnologyDto): Promise<Technology | undefined> {
    const queryRunner = this.connection.createQueryRunner()
